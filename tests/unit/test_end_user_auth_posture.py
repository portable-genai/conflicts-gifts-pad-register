...
read
    ...
    bind_profile == local AND profile chosen AND CONFLICTSPAD_S2S_TOKEN unset
...
from conflicts_gifts_pad_register.adapters.local.identity import (
    LocalIdentityAdapter,
)
from conflicts_gifts_pad_register.adapters.onprem.identity import (
