...
distinct from this service's own inbound ``CONFLICTSPAD_S2S_TOKEN``.
...
_SERVICE_ACTOR = "conflicts-gifts-pad-register"
...
class CloudReviewRouter:
    ...
    def route(self, result: ConflictAssessment, *, maker: str, tenant: str = "") -> str:
