...
INCOMPLETE_MANAGED_OPERATIONS: tuple[str, ...] = (
    "declarations.BigQueryBrokerageFeed.pad_trades",
    "declarations.BigQueryDeclarationFeed.declarations",
    "reference_store.BigQueryReferenceStore.put_blackout",
    "reference_store.BigQueryReferenceStore.put_mnpi",
    "reference_store.BigQueryReferenceStore.put_restricted",
    "reference_store.BigQueryReferenceStore.snapshot",
    "register_store.FirestoreRegisterStore.get",
    "register_store.FirestoreRegisterStore.list_for_employee",
    "register_store.FirestoreRegisterStore.put",
)
